    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700">
            ...
            <div class="px-4 py-4">
                <div class="mb-2">
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-100">
                        Name :- <span class="font-normal dark:text-gray-300">{{$post->user ? $post->user->name : 'Not Found'}}</span>
                    </h3>
                </div>
                <div class="mb-2">
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-100">
                        Email :- <span class="font-normal dark:text-gray-300">{{$post->user ? $post->user->email : 'Not Found'}}</span>
                    </h3>
                </div>
                <div>
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-100">
                    Created At :- <span class="font-normal dark:text-gray-300">{{ \Carbon\Carbon::parse($post->created_at)->format('l d, F Y - h:i A') }}</span>
                    </h3>
                </div>
            </div>
        </div>
